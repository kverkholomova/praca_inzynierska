                            ...
                            children: <Widget>[
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Text("Your application '${streamSnapshot.data?.docs[index]['title']}' is done now!", style: TextStyle(fontSize: 18),textAlign: TextAlign.left,),
                                ),
                              ),
                              Padding(
                                padding: const EdgeInsets.all(10.0),
                                child: Text("We are happy that our app helped you to find an assistance.", style: TextStyle(fontSize: 15),),
                              ),
                              SizedBox(
                                height: 200.0,
                              ),
                                  ...
                                  child: MaterialButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        FirebaseFirestore.instance
                                            ...
                                            .update({"voluneer_rating": _rating});
                                        // sendPushMessage();
                                        //
                                        FirebaseFirestore.instance
                                            .collection('applications')
