...
class DatabaseService{
    ...
    Future updateUserData(String name, String role, String user_name, String phone, List<String> chosen_category, id_vol, double rate, int age, String url_image) async{
