    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        Navigator.of(context, rootNavigator: true).pushReplacement(
            MaterialPageRoute(
                builder: (context) =>
                    isLoggedIn ? MainScreen() : const OptionChoose()));
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
              "You haven't chosen any category, please supply any category to continue"),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          border: Border.all(
            color:
                categoriesVolunteer.contains(text) ? blueColor : Colors.white,
            width: 2,
          ),
