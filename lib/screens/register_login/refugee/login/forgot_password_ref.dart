...
TextEditingController controllerTextFieldForgotPasswordRef =
                          ...
                          child: Column(
                            children: <Widget>[
                              Material(
                                ...
                                child: TextFormField(
                                  controller:
                                      controllerTextFieldForgotPasswordRef,
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: TextButton(
                                ...
                                onPressed: () async {
                                  if (controllerTextFieldForgotPasswordRef
                                      .text.isEmpty) {
                                    setState(() {
                                      errorEmpty = true;
                                    });
    ...
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
              "A letter to reset your password has been sent to your email. Provide a new password and sign in."),
